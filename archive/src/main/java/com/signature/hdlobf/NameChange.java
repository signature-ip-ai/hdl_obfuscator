...
class NameChange {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(
                    "Usage: NameChange <Language Option> <map file> <input file> <output file>" + e.getMessage());
    ...
    private void processSVFile(FileInputStream ins, FileOutputStream optfs, SystemVerilogNoSkipLexer lexer,
            int simpelIDType) {
        String outputString = "";
        try {
            ...
            do {
                ...
                if (t.getType() == simpelIDType) {
                    ...
                    if (idMapLoader.idHMap.containsKey(t.getText())) {
                        // if debug on
                        if (DebugTrue)
                            System.out.print("Value of ID: " + outputString + "\t\trenamed to :");
