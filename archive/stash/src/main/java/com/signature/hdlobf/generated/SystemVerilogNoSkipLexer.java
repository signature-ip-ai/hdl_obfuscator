...
tryAgain:
	...
	protected final void mCONST_LITERAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = CONST_LITERAL;
		int _saveIndex;
	...
	public final void mNUMBER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		else if ((LA(1)=='\'') && (_tokenSet_8.member(LA(2))) && (true) && (true) && (true) && (true)) {
			mCONST_LITERAL(false);
		}
		else {
	...
	private static final long[] mk_tokenSet_8() {
		long[] data = { -8935423135679774720L, 360288511439405182L, 0L, 0L};
		return data;
	}
